          ...
          <div className="wrap">
            ...
            <div className="stats reveal-group">
              ...
              <div className="stat">
                <b>0 papeles</b>
                <span>
                  ventas, stock, compras y cierres quedan guardados en la nube.
                </span>
              </div>
              <div className="stat">
                <b>24/7</b>
                <span>
                  mirá cómo va el kiosco desde el celular, estés donde estés.
                </span>
              </div>
              <div className="stat">
                <b>5 min</b>
                <span>
                  es lo que tarda un empleado nuevo en cobrar su primera venta.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="plans reveal-group">
              <article className="plan">
                <div>
                  ...
                  <p className="plan-desc">
                    La gestión completa del kiosco, todos los días.
                  </p>
                </div>
                ...
                <p className="plan-fine">
                  Luego $19.999/mes. Cancelás cuando quieras.
                </p>
              </article>
              <article className="plan destacado">
                ...
                <div>
                  <h3>Esencial + IA</h3>
                  <p className="plan-desc">
                    Todo lo del plan Esencial, más un asistente que piensa con
                    vos.
                  </p>
                </div>
                <p className="plan-price">
                ...
                <p className="plan-fine">
                  Luego $29.999/mes. Cancelás cuando quieras.
                </p>
              </article>
            </div>
          </div>
