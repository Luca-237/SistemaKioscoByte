...
// Select real de shadcn (Radix). Mantiene el contrato value/onValueChange
// del wrapper anterior; los children ahora son <SelectItem> en vez de <option>.
