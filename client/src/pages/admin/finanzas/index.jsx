...
export function FinanzasPage() {
    ...
    }, [movements, tiposSeleccionados, metodosSeleccionados, busqueda, fechaDesde, fechaHasta]);
    ...
    if (loading && !stats) return <p className="text-muted-foreground">Cargando datos financieros…</p>;
        ...
        <div>
            ...
            <Card className="overflow-hidden p-0 gap-0">
                {movimientosFiltrados.length === 0 ? (
                    <EmptyState message={movements.length === 0 ? "No hay movimientos registrados." : "Sin resultados para los filtros aplicados."} />
                ) : (
                    <>
                        <Table>
                            <TableHeader>
